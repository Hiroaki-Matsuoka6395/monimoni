...
const Transactions: React.FC = () => {
  ...
  const getTypeChip = (type: string) => {
    ...
    const typeInfo = typeMap[type as keyof typeof typeMap] || { label: type, color: 'default' as const }
                ...
                <TableRow key={transaction.id} hover>
                  ...
                  <TableCell sx={{ 
                    ...
                    color: transaction.type === 'income' ? 'green' : 
                           transaction.type === 'expense' ? 'red' : 'inherit'
                  }}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, split_ratio_payer: Number(e.target.value) }))}
                  helperText="%"
                />
              </Grid>
              <Grid item xs={12}>
